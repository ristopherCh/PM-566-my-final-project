...
The state with the highest number deaths per population, `r covid_max[1,state_name]` (`r format(round(covid_max[1,death_perc]), 2)`%), has experienced per population mortality rates `r format(round(covid_max[1,death_perc] / covid_max[nrow(covid_max),death_perc]), 0)`% higher than that of the lowest number of deaths per population, `r covid_max[nrow(covid_max),state_name]` (`r format(round(covid_max[nrow(covid_max),death_perc]), 0)`%).
